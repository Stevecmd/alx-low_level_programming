...
stevecmd@DESKTOP-UTB295U:~/alx-low_level_programming/0x1A-hash_tables$ cat 6-main.c 
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
#include "hash_tables.h"
...
stevecmd@DESKTOP-UTB295U:~/alx-low_level_programming/0x1A-hash_tables$ gcc -Wall -pedantic -Werror -Wextra 6-main.c 0-hash_table_create.c 1-djb2.c 2-key_index.c 3-hash_table_set.c 4-hash_table_get.c 5-hash_table_print.c 6-hash_table_delete.c -o ggcc -Wall -pedantic -Werror -Wextra 6-main.c 0-hash_table_create.c 1-djb2.c 2-key_index.c 3-hash_table_set.c 4-hash_table_get.c 5-hash_table_print.c 6-hash_table_delete.c -o g^C
stevecmd@DESKTOP-UTB295U:~/alx-low_level_programming/0x1A-hash_tables$ gcc -Wall -pedantic -Werror -Wextra 6-main.c 0-hash_table_create.c 1-djb2.c 2-key_index.c 3-hash_table_set.c 4-hash_table_get.c 5-hash_table_print.c 6-hash_table_delete.c -o g
stevecmd@DESKTOP-UTB295U:~/alx-low_level_programming/0x1A-hash_tables$ valgrind ./g
...
==24180== Command: ./g
==24180== 
{'Betty': 'Cool', 'hetairas': 'Bob Z Chu', 'mentioner': 'Bob', 'hetairas': 'Bob Z', 'hetairas': 'Bob', 'python': 'awesome', '98': 'Battery Street', '98': 'Battery Streetz', 'N': 'queens', 'c': 'fun', 'Tim': 'Britton', 'Bob': 'and Kris love asm', 'Asterix': 'Obelix'}
==24180== 
==24180== HEAP SUMMARY:
==24180==     in use at exit: 0 bytes in 0 blocks
==24180==   total heap usage: 44 allocs, 44 frees, 9,744 bytes allocated
==24180== 
