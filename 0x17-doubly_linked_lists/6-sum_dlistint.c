 ...
 *
 * This function iterates through a doubly linked list and calculates the sum of
 * all the integer data elements stored in each node. It returns the total sum
